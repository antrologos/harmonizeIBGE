...
build_education_literacy_1991 <- function(CensusData){

        if(!is.data.frame(CensusData)){
                stop("'CensusData' is not a data.frame")
        }

        check_vars <- check_var_existence(CensusData, c("v0323"))
        ...
        CensusData[v0323 == 2, literacy := 0]
        CensusData[v0323 == 1, literacy := 1]
