...
build_education_literacy_2010 <- function(CensusData){

        if(!is.data.frame(CensusData)){
                stop("'CensusData' is not a data.frame")
        }

        check_vars <- check_var_existence(CensusData, c("v0627"))
        ...
        CensusData[v0627 == 2, literacy := 0]
        CensusData[v0627 == 1, literacy := 1]
